<?php
    ...
    if( $count ) {
        // 2. 连表 倒序 查询 文章和文章分类
        $sql = "select * from {$pre}cate order by cate_id desc limit {$offset}, {$limit}"; 
        $data = getAll($sql); 
            ...
            <div class="card">
                <div class="card-header bg-light">
                    ...
                    <button class="btn btn-primary pull-right rounded" >
                        <a class="fa fa-plus" href="cate_add_edit.php">
                        添加
                        </a>
                    </button>
                </div>
                            ...
                            <tbody>
                                <?php if($count){ foreach ($data as $key => $value){ ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary rounded" href="cate_add_edit.php">
